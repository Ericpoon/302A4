...
var starter = "{:plasticcost|abc:}{:metalcost|:}";
var material = "{:newmaterial|cost|{:`material|name|{{#ifeq|{{{name}}}|tostring|[cost: {{{cost}}}]|{{#ifeq|{{{name}}}|getcost|{{{cost}}}}}}}:}:}";
var plastic = "{:newplastic|chemical|plasticcost|{:`plastic|name|{{#ifeq|{{{name}}}|tostring|[chemical: {{{chemical}}}, cost: {{ {{newmaterial|{{#ifeq|{{{plasticcost}}}|[object Object]|default cost|{{{plasticcost}}}}} }}|getcost}}]|{{#ifeq|{{{name}}}|getchemical|{{{chemical}}}| {{ {{newmaterial| {{#ifeq|{{{plasticcost}}}|[object Object]|default cost|{{{plasticcost}}}}}  }}|{{{name}}} }} }} }} :}:}";
...
str += "\n\n";
str += "\n{{ {{newbutton|plastic|shank|2.5|poly|integral|456}}| getselfshank }}";
str += "\n{{ {{newbutton|plastic|shank|2.5|poly|integral|456}}| getcost }}";
str += "\n{{ {{newbutton|plastic|shank|2.5|poly|integral|456}}| getnumber }}";


var cons = "{:cons|{:`|x|y| {:`|f|{{ {{{f}}}|{{{x}}}|{{{y}}} }}:}:}:}";
var car = "{:car|{:`|c|{{ {{{c}}}| {:`t|x|y|{{{x}}}:} }}:}:}";
var cdr = "{:cdr|{:`|c|{{ {{{c}}}| {:`t|x|y|{{{y}}}:} }}:}:}";
...
// str += "{{ {{cons}}| 1234| asdf}}";
str += "car: {{ {{car}} | {{ {{cons}}|A|B}} }}\n";
str += "cdr: {{ {{cdr}} | {{ {{cons}}|First|Second}} }}";
