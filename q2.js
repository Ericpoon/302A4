...
function unstringify(s) {
    ...
    try {
        ...
        if (typeof(thunk) !== 'object' || !("binding" in thunk) || !("envs" in thunk))
            return null;
...
var button = "{:newbutton| mtype| atype| lignenumber| marg|aarg| buttoncost|{:`|name|  {{#ifeq|{{{name}}}|getmaterialtype|{{{mtype}}}|{{#ifeq|{{{name}}}|getattachmenttype|{{{atype}}}|  {{ #ifeq|{{{mtype}}}|plastic|{{ {{newplastic|{{{marg}}}|{{{buttoncost}}} }}| {{{name}}} }}|{{ {{ newmetal|{{{marg}}}|{{{buttoncost}}} }}|{{{name}}} }} }}{{#ifeq|{{{atype}}}|holed|{{ {{newholed|{{{aarg}}} }}|{{{name}}} }}|{{ {{newshank|{{{aarg}}} }}|{{{name}}} }}}} }}}}:}:}";
var button = "{:newbutton| mtype| atype| lignenumber| marg|aarg| buttoncost|{:`|name|{{#ifeq|{{{name}}}|tostring| [lignenumber: {{{lignenumber}}}, material: {{{mtype}}}, {{#ifeq|{{{mtype}}}|plastic|chemical: {{{marg}}}|ferrous: {{{marg}}} }}, cost: {{ {{newmaterial|{{#ifeq|{{{buttoncost}}}|[object Object]|default|{{{buttoncost}}}}} }}|getcost}}, {{#ifeq|{{{atype}}}|holed|number: {{{aarg}}}|selfshank: {{{aarg}}} }}] | {{#ifeq|{{{name}}}|getmaterialtype|{{{mtype}}}|{{#ifeq|{{{name}}}|getattachmenttype|{{{atype}}}|  {{ #ifeq|{{{mtype}}}|plastic|{{ {{newplastic|{{{marg}}}|{{{buttoncost}}} }}| {{{name}}} }}|{{ {{ newmetal|{{{marg}}}|{{{buttoncost}}} }}|{{{name}}} }} }}{{#ifeq|{{{atype}}}|holed|{{ {{newholed|{{{aarg}}} }}|{{{name}}} }}|{{ {{newshank|{{{aarg}}} }}|{{{name}}} }}}} }} }} }}:}:}";
...
var button1 = "{{newbutton|plastic|shank|2.5|poly|integral|123}}";
var button2 = "{{newbutton|plastic|shank|3.0|non-poly|integral|88}}";
var button3 = "{{newbutton|plastic|shank|2.5|poly|integral}}";
var button4 = "{{newbutton|metal|holed|1.8|no-ferrous|4|50}}";
...
var buttoncollection = "{:buttoncollection|buttons|title|filter|  \n====== {{{title}}} ====== \n{{ iterate|{{{buttons}}}|{{{filter}}} }}  :}";


// var iterator = "{:iterate|list| {{#ifeq| {{{list}}} | null |EOF reached | Elem:{{ {{ {{car}}|{{{list}}} }} | tostring }},\n {{iterate| {{ {{cdr}}|{{{list}}} }} }} }} :}";
// var iterator = "{:iterate|list|filter| {{#ifeq| {{{list}}} | null |EOF reached | Elem:{{ {{ {{car}}|{{{list}}} }} | getmaterialtype }},{{ {{ {{car}}|{{{list}}} }} | getattachmenttype }}{{ {{ {{car}}|{{{list}}} }} | tostring }},\n {{iterate| {{ {{cdr}}|{{{list}}} }} }} }} :}";
// var iterator = "{:iterate|list|filter| {{#ifeq| {{{list}}} | null |EOF reached | Elem:{{ {{ {{car}}|{{{list}}} }} | tostring }},\n {{iterate| {{ {{cdr}}|{{{list}}} }} }} }} :}";

var iterator = "{:iterate|list|filter| {{#ifeq| {{{list}}} |null|| {{#ifeq|{{{filter}}}|[object Object]|no filter: Elem:{{ {{ {{car}}|{{{list}}} }} | tostring }}\n- |" + "{{#ifeq|{{ {{ {{car}}|{{{list}}} }} | getmaterialtype }}|{{{filter}}}| material filter Elem:{{ {{ {{car}}|{{{list}}} }} | tostring }}\n- | {{#ifeq|{{ {{ {{car}}|{{{list}}} }} | getattachmenttype }}|{{{filter}}}| attachment filter Elem:{{ {{ {{car}}|{{{list}}} }} | tostring }}\n- |}} }} " + "  }} {{iterate| {{ {{cdr}}|{{{list}}} }}| {{{filter}}} }} }} :}";

str += iterator;

str += buttoncollection;

str += "{{buttoncollection|" + list + "|Table of Buttons}}";
