...
// var plastic = "{:newplastic| {{ {:`setdefaultplastic|cost| {:`new|chemical|cost| {:`plastic|name| {{#ifeq|{{{name}}}|tostring| [chemical: {{{chemical}}}, cost: {{ {{newmaterial|{{{cost}}}}}|getcost}} ] |{{#ifeq|{{{name}}}|getchemical|{{{chemical}}}| {{ {{newmaterial|{{{cost}}}}}|{{{name}}} }} }} }} :}:} :}|P999}} :}";
// var plastic = "{:newplastic|chemical|plasticcost| {:`plastic|name| {{#ifeq|{{{name}}}|tostring| [chemical: {{{chemical}}}, cost: {{ {{newmaterial|{{{plasticcost}}}}}|getcost}} ] |{{#ifeq|{{{name}}}|getchemical|{{{chemical}}}| {{ {{newmaterial|{{{plasticcost}}}}}|{{{name}}} }} }} }} :}:}";
...
// var metal = "{:newmetal| {{ {:`setdefaultmetal|cost| {:`new|ferrous|cost| {:`metal|name|{{#ifeq|{{{name}}}|getferrous|{{{ferrous}}}|            {{ {{newmaterial|{{{cost}}}}}|{{{name}}} }} }} :}:} :}|M999}} :}";
// var metal = "{:newmetal|ferrous|metalcost| {:`metal|name|{{#ifeq|{{{name}}}|getferrous|{{{ferrous}}}|            {{ {{newmaterial|{{{metalcost}}}}}|{{{name}}} }} }} :}:}";
...
// var holed = "{:newholed| {{ {:`setdefaultholed|property| {:`new|number| {:`holed|name|{{#ifeq|{{{name}}}|getnumber|{{{number}}}|          {{ {{newattachment|{{{property}}}}}|{{{name}}} }} }} :}:} :}|H888}} :}";
var holed = "{:newholed|number| {:`holed|name|{{#ifeq|{{{name}}}|tostring| [number: {{{number}}}] | {{#ifeq|{{{name}}}|getnumber|{{{number}}} }} }} :}:}";
// var shank = "{:newshank| {{ {:`setdefaultshank|property| {:`new|selfshank| {:`holed|name|{{#ifeq|{{{name}}}|getselfshank|{{{selfshank}}}| {{ {{newattachment|{{{property}}}}}|{{{name}}} }} }} :}:} :}|H888}} :}";
...
// str += plastic + "{{{{ {{newplastic}}|polyurethane|11}}|getchemical}}";
str += plastic + "{{ {{ newplastic|ABC}}| getcost}}";
// str += "{{{{ {{newplastic}}|polyurethane|13}}|getcost}}";
// str += metal + "{{{{ {{newmetal}}|no|21}}|getferrous}}";
// str += "{{{{ {{newmetal}}|no|23}}|getcost}}";
// str += attachment;
// str += holed + shank;
// str += "{{{{ {{newholed}}|2}}|getnumber}}";
// str += "{{{{ {{newshank}}|integral}}|getselfshank}}";
//
// str += "\n\n";
// str += "{:talkaboutplastic|p|A {{ {{{p}}}|getchemical}} button costs {{ {{{p}}}|getcost}}.:} {{talkaboutplastic|{{ {{newplastic}}|polyurethane}}}}";
// str += "\n\n";
// str += "{:talkaboutplastic|p|A {{ {{{p}}}|getchemical}} button costs {{ {{{p}}}|getcost}}.:} {{talkaboutplastic|{{ {{newplastic}}|unknown|100}}}}";
// str += "\n\n";
...
// globalEnv.bindings = {"plasticcost": 222, "metalcost": 888};
